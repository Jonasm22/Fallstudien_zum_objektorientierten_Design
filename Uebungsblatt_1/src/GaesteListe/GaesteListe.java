...
public class GaesteListe {
    ...
    public  void invitePerson(String firstName,  String email)  {
        if(existPerson(email)){
            System.out.println("ERROR-- this Email: " + email +  " --- has already received its invitation");
        } else {
            invitePerson.add(new PersonalData(firstName, email ));
            System.out.println( "Name: " + firstName + " Email: "+ email+ " +++ The invitation was sent successfully" );
        }
    ...
    public static void main(String[] args) {
        ...
        event.invitePerson("Maria ", "MariaMustermann@hnu.de");  // Same name but Email is different
